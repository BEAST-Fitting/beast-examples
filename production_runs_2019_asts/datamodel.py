...
obsfile = "./data/M31-B17-WEST.st.fits"
...
ast_density_table = "./data/M31-B17-WEST.st_sourceden_map.hd5"
...
# photometry.
ast_reference_image = "./data/M31-B17-WEST_F475W_drz_head.fits"
...
astfile = "./data/M31-B17-WEST.gst.fake.fits"
...
z = (10**np.array([-2.1, -1.5, -0.9, -0.3, 0.3]) * 0.0152).tolist()
...
extLaw = extinction.Generalized_RvFALaw(ALaw=extinction.Generalized_DustExt(curve='F20'),
